...
\end{frame}
\subsection{Informationsreduktion}
...
\begin{frame}[fragile]{FSST: Fast Random Access String Compression \cite{fsst}}
	\begin{columns}[T]
		...
		\end{figure}
	\end{columns}
	\footnotetext{\color{BaseColor}BNL20  \color{black}Boncz, P.; Neumann, T.; Leis, V. (2020). \emph{FSST: Fast Random Access String Compression}.}
\end{frame}

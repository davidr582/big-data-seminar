...
\subsection{Implementierung}\label{im}
...
Bilder verwenden?
Macht ein graph mit decompression throughput und/oder compression rates sinn? Vergleichbar wegen unterschiedlicher datasets?
Ist es sinnvoll überhaupt genaue Zahlen zu verwenden, da der Vergleich aufgrund unterschiedlicher Datensätze eher schwierig ist?
\section{TODOs}
Seitenzahlen bei büchern (bei jedem mal eigene citation?)
